...
async def run_infer(
    data_dir: str,
    output_dir: str,
    config_name: str = "qwen2_5_vl_32b",
    split: str = "train",
    limit: int = -1,
    log_every: int = 100,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="outputs_ocrbench_qwen32b")
    parser.add_argument("--config-name", type=str, default="qwen2_5_vl_32b",
