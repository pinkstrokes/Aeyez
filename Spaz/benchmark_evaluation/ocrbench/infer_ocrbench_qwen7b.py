...
async def run_infer(
    data_dir: str,
    output_dir: str,
    config_name: str = "qwen2_5_vl_7b_dashscope",
    split: str = "train",
    limit: int = -1,
    log_every: int = 100,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="outputs_ocrbench_qwen7b")
    parser.add_argument("--config-name", type=str, default="qwen2_5_vl_7b_dashscope",
